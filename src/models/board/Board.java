...
public class Board {
    ...
    public boolean addShip(Ship ship) throws BoardException, PositionException {
        ...
        if (!thereIsShip(ship.getPosition())){
            if (thereIsSpace(ship)){
                ...
                else throw new BoardException("Error, hay otro barco cerca");
            }
            else throw new BoardException("Error, no hay lugar para ese barco en esa dirección");
        }
        else throw new BoardException("Error, ya hay un barco en esa posición");
    }
    public boolean addHit(Position position) throws BoardException {
        ...
        else throw new BoardException("Error, ya has disparado en esta posición");
    }
